...
if (openFileButton) {
   ...
   const newScreenCaptureButton = newOpenFileButton.cloneNode(true);
   newScreenCaptureButton.textContent = ""⬚"";
   saveButtonParent?.insertBefore(newScreenCaptureButton, saveButtonParent.firstChild);
}
